    ...
    class KitchenCreate < Chef::Knife
      ...
      def run
       ...
       # if self.config[:kitchen_template].eql? "windows"
          ...
          @windows_box=config[:windows_box] || "nc_windows2008r2"
          @windows_box_url=config[:windows_box_url] || "http://skpkstscloud01.dowjones.net/chef/vbox/windows/win2008r2-news-corp.box"
          @box_hostname=config[:box_hostname] || "nc_windows2008r2"
       # end
